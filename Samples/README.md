...
- **ShowResp:** Feedback of which button was pressed and which marker was sent with a duration of 1000 ms
...
The InitMarkerDevices InLine provides an example on how to send markers to the different marker devices. This is done with the WriteByte method. In the Multiple_Marker_Devices sample task marker value 255 (all bits high) is sent to both devices for 100 ms, then reset to 0.
